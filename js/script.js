                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">Runtime : `+movie.Runtime+`</h3></li>
                                    <li class="list-group-item">Language : `+movie.Language+`</h3></li>
                                    <li class="list-group-item">Country : `+movie.Country+`</h3></li>
